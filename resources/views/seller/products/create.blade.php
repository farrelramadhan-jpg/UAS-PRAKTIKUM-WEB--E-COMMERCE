                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="sku" class="w-full px-4 py-2 border rounded" required>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold mb-2">Deskripsi</label>
                            <textarea name="description" rows="6" class="w-full px-4 py-2 border rounded" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="price" class="w-full px-4 py-2 border rounded" required>
                            </div>
                            <div>
